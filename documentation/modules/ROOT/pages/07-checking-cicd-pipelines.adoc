...
----
https://console-openshift-console.apps.%BASE_SUBDOMAIN%/k8s/ns/gramola-cicd{dash}%USERNAME%/tekton.dev~v1beta1~Pipeline/events-ci-pl
----

You can have a look to the diagram, hover over the tasks or take a look to the yaml.
      ...
      spec:
        params:
          ...
          - name: GIT_REPO_CONFIG
            value: >-
              https://repository-gitea-system.apps.cluster-vw6xw.vw6xw.sandbox27.opentlc.com/user1/gramola.git
          - name: GIT_REVISION_CONFIG
            value: main
          - name: IMAGE_NAME
            value: quay.io/esquife/gramola-events
          - name: IMAGE_TAG
            value: $(tt.params.gitRevision)
          - name: PATH_CONTEXT
            value: .
