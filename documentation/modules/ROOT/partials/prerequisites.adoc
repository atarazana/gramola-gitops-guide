...
| https://dl.k8s.io/release/{kubernetes-version}/bin/darwin/amd64/kubectl[Download]
| https://dl.k8s.io/release/{kubernetes-version}/bin/linux/amd64/kubectl[Download]
| https://dl.k8s.io/release/{kubernetes-version}/bin/windows/amd64/kubectl.exe[Download]
