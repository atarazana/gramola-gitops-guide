...
----
{"eventListener":"events-ci-pl-push-gitea-listener","namespace":"gramola-cicd-user1","eventListenerUID":"6faba931-1949-4e8c-94be-e3c85608f13d","eventID":"a4f352e1-0088-4339-b671-4287d770e8b5"}
----
...
oc logs deployment/el-events-ci-pl-push-{git-provider}-listener -n ${CICD_NAMESPACE} | grep dummy
----
...
Send the `dummy` event to the Events CD web hook:
...
export USERNAME="{username}"
export CICD_NAMESPACE="gramola-cicd-$\{USERNAME}"
oc logs deployment/el-events-cd-pl-pr-{git-provider}-listener -n ${CICD_NAMESPACE} | grep dummy
----
...
export USERNAME="{username}"
export CICD_NAMESPACE="gramola-cicd-$\{USERNAME}"
oc logs deployment/el-gateway-ci-pl-push-{git-provider}-listener -n ${CICD_NAMESPACE} | grep dummy
----
...
export USERNAME="{username}"
export CICD_NAMESPACE="gramola-cicd-$\{USERNAME}"
oc logs deployment/el-gateway-cd-pl-pr-{git-provider}-listener -n ${CICD_NAMESPACE} | grep dummy
----
