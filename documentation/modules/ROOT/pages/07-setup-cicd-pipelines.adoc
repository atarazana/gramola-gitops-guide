...
https://console-openshift-console.apps.cluster-prhg6.prhg6.sandbox770.opentlc.com/k8s/ns/gramola-cicd-user1/tekton.dev~v1beta1~Pipeline/events-ci-pl

[#events-cd-pipeline]
=== Events CD Pipeline

Navigate back and open the *CD pipeline*, again for *gramola-events*, called *'events-cd-pl'*. This time the list of tasks is even shorter...
