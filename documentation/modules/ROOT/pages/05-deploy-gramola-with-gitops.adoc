...
The next command creates a Root Application called *gramola-root-app* that points to our configuration repository https://{gitea-host}/{username}/gramola[here^] and folder *argocd/root-apps*.
